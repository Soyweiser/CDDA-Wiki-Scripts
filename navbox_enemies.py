...
#documentation
#data is uploaded automatically, used for the Template:Navbox/enemies page.
...
#the following dict is made for monster id's and specific wiki page names. For example the 'mon_dog_thing' has as a page name 'Dog (nether)', but the links are called 'dog' for spoilers sake.
monster_name_hacks = { 'mon_dog_thing' : 'Dog (nether)|Dog', 'mon_triffid_heart' : 'Triffid heart (creature)|Triffid heart', 'mon_shia' : 'Shia LaBeouf' }
