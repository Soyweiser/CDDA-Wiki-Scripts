...
while True:
    while var.isdigit():
        ...
        if(var < 0):
            ...
            root.destroy()
            exit()
        output = [ "<!-- Automatically generated by https://github.com/Soyweiser/CDDA-Wiki-Scripts The trait.py script. Any edits made to this can and will be overwritten. Please contact [[User:Soyweiser|Soyweiser]] if you want make changes to this page.-->{{trait|", data[var]["id"], '|', data[var]["name"], '|' ]
