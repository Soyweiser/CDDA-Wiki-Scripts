...
monster_name_hacks = { 'mon_dog_thing' : 'Dog (nether)|Dog', 'mon_triffid_heart' : 'Triffid heart (creature)|Triffid heart', 'mon_breather' : 'Breather (spawn)|Breather spawn', 'mon_wolf' : 'Wolf (monster)|wolf' }
